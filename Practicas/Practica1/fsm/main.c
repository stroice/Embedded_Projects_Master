...
static gateState gatePosition;
static int gatePosition_raise(fsm_t* this) { if (gatePosition == raise) return 1; else return 0; }
static int gatePosition_lower(fsm_t* this) { if (gatePosition == lower) return 1; else return 0; }


static bool carAtGate;
static int carAtGate_active(fsm_t* this) { return carAtGate; }

static bool carJustExit;
